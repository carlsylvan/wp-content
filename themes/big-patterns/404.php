	...
	if ( is_active_sidebar( 'sidebar-1' ) || has_nav_menu('menu-2') ) :
		...
		?>
			<header class="page-header">
				<h1 class="page-title"><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'big-patterns' ); ?></h1>
			</header><!-- .page-header -->

			<div class="page-content">
				<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try one of the menu links or a search.', 'big-patterns' ); ?></p>
