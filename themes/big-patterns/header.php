...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'big-patterns' ); ?></a>
	<?php 
		...
		//The page has header or featured media, so don't show the backgorund image
			...
			<div class="bb-backVid">
				<video src="<?php echo esc_url(wp_get_attachment_url($bb_backVid))?>" preload="auto" autoplay muted alt="<?php esc_attr_e( 'Backgroound Video', 'big-patterns' ); ?>" />
				</div>
			<?php
		}
		?>
	...
	//The page has header or featured media or it is a big page, so don't show the backgorund image
		...
		if (wp_get_attachment_url($bb_backImg)) {
            ...
            ?>
				<img src="<?php echo esc_url(wp_get_attachment_url($bb_backImg))?>" alt="<?php esc_attr_e( 'Backgroound Image', 'big-patterns' ); ?>" />
			<?php
        	}?>
		</div>
	<?php
