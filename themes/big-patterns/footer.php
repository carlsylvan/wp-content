...
?>
	...
	if ( ((!is_active_sidebar( 'sidebar-3' ) && !has_nav_menu('menu-4')) && is_page())
		|| ((!is_active_sidebar( 'sidebar-1' ) && !has_nav_menu('menu-2')) && (is_home() || is_archive() || is_search() || is_404() || is_single()))
		...
		<div class="site-info">
			<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'big-patterns' ) ); ?>">
				<?php
				/* translators: %s: CMS name, i.e. WordPress. */
				printf( esc_html__( 'Powered by %s', 'big-patterns' ), 'WordPress' );
				?>
			</a>
			<span class="sep"> | </span>
				<?php
				/* translators: 1: Theme name, 2: Theme author. */
				printf( esc_html__( 'Theme: %1$s by %2$s.', 'big-patterns' ), '<a href="https://wordpress.org/themes/big-patterns/">Big Patterns</a>', '<a href="https://bigbobnetwork.com/">BigBobNetWork</a>' );
				?>
		</div><!-- .site-info -->
